...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        ///////////改成项目app
        dsc.setUrl("jdbc:mysql://localhost:3306/app?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8");
...
//      pc.setModuleName(scanner("模块名"));
        ...
        pc.setEntity("entity");   //生成实体类存入到 com.app.entity
...
//         String templatePath = "/templates/mapper.xml.vm";
        ...
        */
        ...
        // 公共父类--所有项目 控制器的父类
        strategy.setSuperControllerClass("com.app.common.BaseController");
        ...
        strategy.setControllerMappingHyphenStyle(false); // RequestMapping种的驼峰是否转成用"_"连接, 默认是false  category_id   实体类属性 categoryId
